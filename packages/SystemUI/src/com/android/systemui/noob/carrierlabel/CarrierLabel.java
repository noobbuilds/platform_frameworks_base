...
package com.android.systemui.noob.carrierlabel;
...
import com.android.internal.util.noob.NOOBUtils;
...
import com.android.systemui.noob.carrierlabel.SpnOverride;
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyIntents.SPN_STRINGS_UPDATED_ACTION.equals(action)
                ...
                isCN = NOOBUtils.isChineseLanguage();
            }
        }
    };
